...
If your project paths differ, adjust the commands accordingly. Ensure the React dev server origin (e.g., `https://localhost:5173`) matches the value in `appsettings.Development.json` so CORS stays in sync.
